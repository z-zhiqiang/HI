...
public class GenRunCoarseFineGrainedInstrumentScript extends AbstractGenRunScript implements GenRunInstrumentScript {
	...
	public GenRunCoarseFineGrainedInstrumentScript(String sub, String ver, String cc, String sD, String eD, String oD, String scD, String tD, String failing, String passing) {
...
//		code.append("rm $TRACESDIR/o*profile\n");
		...
		printToFile(code.toString(), scriptDir, version + "_cfg.sh");
	}
	...
	private void stmts(StringBuffer code) {
		for (Iterator<Integer> it = failingTests.iterator(); it.hasNext();) {
			...
			code.append("$VERSIONSDIR/" + version + "_cfinst.exe ");//executables
