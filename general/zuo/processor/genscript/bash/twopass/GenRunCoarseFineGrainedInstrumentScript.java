...
public class GenRunCoarseFineGrainedInstrumentScript extends AbstractGenRunScript implements GenRunInstrumentScript {
	...
	public GenRunCoarseFineGrainedInstrumentScript(String sub, String ver, String subV, String cc, String eD, String oD, String scD, String tD, String failing, String passing) {
	...
	private void stmts(StringBuffer code) {
		for (Iterator<Integer> it = failingTests.iterator(); it.hasNext();) {
			...
			code.append("$VERSIONSDIR/" + subVersion + "_cfinst.exe ");//executables
